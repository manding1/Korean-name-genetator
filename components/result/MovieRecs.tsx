...
export default function MovieRecs({ recommendations }: MovieRecsProps) {
  ...
  return (
    <section className="py-10 px-6" style={{ borderBottom: '1px solid var(--line)', background: 'linear-gradient(180deg, var(--maize-tint) 0%, var(--paper) 100%)' }}>
      <p className="text-xs font-semibold tracking-[0.25em] uppercase mb-6" style={{ color: 'var(--maize-text)' }}>
        ...
        <div className="p-5" style={{ background: 'var(--paper)' }}>
          <div className="flex items-start justify-between mb-2">
            ...
            <div className="shrink-0 ml-3 text-right">
              <span className="text-lg font-bold" style={{ color: 'var(--maize-text)' }}>
                {best.match_score}%
              </span>
          ...
          <div className="flex gap-1.5 flex-wrap mb-3">
            {genres(best).map((g) => (
              <span
                ...
                style={{ background: 'var(--maize-tint)', color: 'var(--maize-text)' }}
              >
                {g}
              </span>
            ))}
          ...
          <a
            ...
            style={{ background: 'var(--maize-text)', color: '#fff' }}
          >
            ...
            >
              ...
              <div className="flex-1 p-3.5" style={{ background: 'var(--paper)' }}>
                <div className="flex items-start justify-between mb-0.5">
                  ...
                  <span className="text-sm font-bold shrink-0 ml-2" style={{ color: 'var(--maize-text)' }}>
                    {rec.match_score}%
                  </span>
                </div>
